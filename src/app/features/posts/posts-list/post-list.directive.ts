...
export class PostListDirective {
    public readonly virtualScroll = input<UiVirtualScrollComponent<Post> | null>(null);
    ...
    public onWindowKeydown(event: Event): void {
        ...
        switch (keyboardEvent.key) {
            ...
            case 'Enter': {
                ...
                if (this.isEditableFieldTarget(keyboardEvent.target) || posts.length === 0) {
                    return;
                }
